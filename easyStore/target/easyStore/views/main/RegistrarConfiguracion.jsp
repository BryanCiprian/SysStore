												...
												<div id="bootstrap-wizard-1" class="col-sm-12">
													...
													<div class="tab-content">
														<div class="tab-pane active" id="tab1">
															<br>
															<h3><strong>Paso 1 </strong> - Datos de la Empresa</h3>
															...
															<div class="row">
																<div class="col-sm-6">
																	<div class="form-group">
																		<div class="input-group">
																			...
																			<input class="form-control input-lg" placeholder="Nombre Empresa" type="text" name="eName" id="fname">
																...
																<div class="col-sm-6">
																	<div class="form-group">
																		<div class="input-group">
																			...
																			<input class="form-control input-lg" placeholder="Numero de ruc" type="text" name="nRuc" id="lname">
																...
																<div class="col-sm-6">
																	<div class="form-group">
																		<div class="input-group">
																			...
																			<input class="form-control input-lg" placeholder="Direccion de la empresa" type="text" name="dEmpresa" id="email">
																...
																<div class="col-sm-6">
																	<div class="form-group">
																		<div class="input-group">
																			<span class="input-group-addon"><i class="fa fa-building fa-lg fa-fw"></i></span>
																		<select class="form-control input-lg" name="tEmpresa">
																				<option value="" selected="selected">Tipo de Empresa</option>
													...
													<div class="col-md-10">
														...
														<p class="help-block">
															de prefferencia en formato png.
														</p>
													</div>
												</div>
																</div>
			...
			<div class="panel panel-primary">
				...
				<form class="form-config">
					<div class="form-group2">
						<input class="form-control" id="txtNomEmpresa"
							name="txtNomEmpresa" maxlength="30" type="text"
							placeholder="Ingrese Nombre de la empresa" required="required">
					</div>
					<div class="form-group2">
						<input class="form-control" id="txtRucEmpresa"
							name="txtRucEmpresa" maxlength="30" type="text"
							placeholder="Ingrese RUC de la empresa" required="required">
					</div>
					<div class="form-group2">
						<input class="form-control" id="txtDirEmpresa"
							name="txtDirEmpresa" maxlength="30" type="text"
					...
					<div class="form-group2">
						<select name="txtPosEmpresa" class="txtPosEmpresa"
							...
							<option value="top-navigation container">Menu on Top
								with center content</option>
					...
					<div class="form-group2">
						<input class="form-control" id="txtUsuEmpresa"
							name="txtUsuEmpresa" maxlength="30" type="text"
